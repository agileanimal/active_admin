module ActiveAdmin
  class FormBuilder < ::Formtastic::FormBuilder
    ...
    def js_for_has_many(association, form_block, template)
      ...
      onclick = "$(this).siblings('li.input').append('#{js}'.replace(/#{placeholder}/g, new Date().getTime())); if(typeof #{association_reflection.klass.model_name.underscore}_added == 'function'){ #{association_reflection.klass.model_name.underscore}_added(); }; return false;"
